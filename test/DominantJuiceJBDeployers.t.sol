...
// All 41 tests passing on forked url. No mocks, sosuccessProjectID "forge test" on local Anvil network does not work.
...
contract DominantJuiceTest_Unit is Test {
    ...
    DominantJuice domSuccessClone;
    DominantJuice domFailClone;
    MyDelegateDeployer delegateDeployer;
    MyDelegateProjectDeployer delegateProjectDeployer;
    ...
    uint256 public successProjectID;
    uint256 public failProjectID;
    ...
    function setUp() external {
        ...
        (controller, paymentTerminalStore3_1_1, goerliETHTerminal3_1_1, delegateDeployer, delegateProjectDeployer) =
            deployContracts.run();
        ...
        successProjectID = delegateProjectDeployer.launchProjectFor(
        ...
        dominantJuice = DominantJuice(metadata.dataSource);
        owner = payable(dominantJuice.owner());
        vm.deal(owner, STARTING_USER_BALANCE);
    }

    function testDelegateOwner() public {
        assertEq(dominantJuice.owner(), msg.sender);
    }

    function testProjectLaunch() public {
        // (JBFundingCycle memory fundingCycle,) = controller.currentFundingCycleOf(successProjectID);
    ...
    function testReconfigure() public {
        vm.startPrank(owner);
        dominantJuice.depositRefundBonus{value: TOTAL_REFUND_BONUS}(TOTAL_REFUND_BONUS);
        delegateProjectDeployer.reconfigureFundingCyclesOf(successProjectID, 1);
        (JBFundingCycle memory fundingCycle2_success,) = controller.queuedFundingCycleOf(successProjectID);
    ...
    //     dominantJuice.initialize(successProjectID, CYCLE_TARGET, MIN_PLEDGE_AMOUNT, MAX_EARLY_PLEDGERS);
    // }
    ...
    //     (JBFundingCycle memory projectCycleData,) = controller.currentFundingCycleOf(successProjectID);
    ...
    //     // IJBPaymentTerminal[] memory terminals = directory.terminalsOf(successProjectID);
    //     vm.expectRevert(DominantJuice.DataSourceNotInitialized.selector);
    //     goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
    //         successProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger1, 0, false, "", new bytes(0)
    //     );
    ...
    //     vm.prank(earlyPledger2);
    //     goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
    //         successProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger2, 0, false, "", new bytes(0)
    //     );
    //     vm.prank(pledger);
    //     goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
    //         successProjectID, MIN_PLEDGE_AMOUNT, ethToken, pledger, 0, false, "", new bytes(0)
    ...
    //     vm.startPrank(owner);
    //     dominantJuice.initialize(failProjectID, CYCLE_TARGET, MIN_PLEDGE_AMOUNT, MAX_EARLY_PLEDGERS);
    //     dominantJuice.depositRefundBonus{value: TOTAL_REFUND_BONUS}(TOTAL_REFUND_BONUS);
    //     vm.stopPrank();
    //     vm.prank(earlyPledger1);
    //     goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
    //         failProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger1, 0, false, "", new bytes(0)
    //     );
    //     vm.prank(earlyPledger2);
    //     goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
    //         failProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger2, 0, false, "", new bytes(0)
    //     );
    //     vm.prank(pledger);
    //     goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
    //         failProjectID, MIN_PLEDGE_AMOUNT, ethToken, pledger, 0, false, "", new bytes(0)
    //     );

    //     vm.warp(block.timestamp + 100);
    //     vm.prank(owner);
    //     controller.reconfigureFundingCyclesOf(
    //         failProjectID, _data, _metadataFailedCampaign, block.timestamp, _groupedSplits, _fundAccessConstraints, ""
    //     );
    //     vm.warp(block.timestamp + CYCLE_DURATION + 100);
    //     _;
    // }
    ...
    //     goerliETHTerminal3_1_1.redeemTokensOf(
    //         earlyPledger2, successProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger2, 0, false, "", new bytes(0)
    //     );
    ...
    //     vm.expectRevert();
    //     goerliETHTerminal3_1_1.redeemTokensOf(
    //         earlyPledger2, successProjectID, MIN_PLEDGE_AMOUNT, ethToken, 0, earlyPledger2, "", new bytes(0)
    //     );
    //     vm.stopPrank();
    // }
    ...
    //     vm.prank(pledger);
    //     goerliETHTerminal3_1_1.redeemTokensOf(
    //         pledger, failProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, pledger, "", new bytes(0)
    //     );
    ...
    //     vm.startPrank(earlyPledger2);
    //     goerliETHTerminal3_1_1.redeemTokensOf(
    //         earlyPledger2, failProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, earlyPledger2, "", new bytes(0)
    //     );
    ...
    //     vm.prank(earlyPledger1);
    //     goerliETHTerminal3_1_1.redeemTokensOf(
    //         earlyPledger1, failProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, earlyPledger1, "", new bytes(0)
    //     );
    //     uint256 numEarlyPledgers = dominantJuice.numEarlyPledgers();
    ...
    //     vm.prank(earlyPledger1);
    //     uint256 reclaimed = goerliETHTerminal3_1_1.redeemTokensOf(
    //         earlyPledger1, failProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, earlyPledger1, "", new bytes(0)
    //     );
