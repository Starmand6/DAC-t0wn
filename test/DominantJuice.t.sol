...
contract DominantJuiceTest_Unit is Test {
    ...
    function testPayParamsRevertsBeforeInit() public {
        ...
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            successfulProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger1, 0, false, "", new bytes(0)
        );
    }
    ...
    function testDidPayStopsAssigningEarlies() public ownerHasDepositedBonus oneEarlyPledgerPaid {
        ...
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            successfulProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger2, 0, false, "", new bytes(0)
        );
        vm.prank(pledger);
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            successfulProjectID, MIN_PLEDGE_AMOUNT, ethToken, pledger, 0, false, "", new bytes(0)
        );
    ...
    modifier successfulCycleHasExpired() {
        ...
        goerliETHTerminal3_1_1.pay{value: CYCLE_TARGET}(
            successfulProjectID, CYCLE_TARGET, ethToken, earlyPledger2, 0, false, "", new bytes(0)
        );
        vm.prank(pledger);
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            successfulProjectID, MIN_PLEDGE_AMOUNT, ethToken, pledger, 0, false, "", new bytes(0)
    ...
    modifier depositedBonusAndFailedCycleHasExpired() {
        ...
        vm.prank(earlyPledger1);
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            failedProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger1, 0, false, "", new bytes(0)
        );
        vm.prank(earlyPledger2);
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            failedProjectID, MIN_PLEDGE_AMOUNT, ethToken, earlyPledger2, 0, false, "", new bytes(0)
        );
        vm.prank(pledger);
        goerliETHTerminal3_1_1.pay{value: MIN_PLEDGE_AMOUNT}(
            failedProjectID, MIN_PLEDGE_AMOUNT, ethToken, pledger, 0, false, "", new bytes(0)
        );
    ...
    function testRedeemRevertsDuringCycle() public ownerHasDepositedBonus {
        ...
        goerliETHTerminal3_1_1.redeemTokensOf(
            earlyPledger2, successfulProjectID, MIN_PLEDGE_AMOUNT, ethToken, 0, earlyPledger2, "", new bytes(0)
        );
        vm.stopPrank();
    }
    ...
    function testRedeemSkipsRefundForRegPledgers() public depositedBonusAndFailedCycleHasExpired {
        ...
        vm.prank(pledger);
        goerliETHTerminal3_1_1.redeemTokensOf(
            pledger, failedProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, pledger, "", new bytes(0)
        );
    ...
    function testRedeemRevertsIfAlreadyWithdrawn() public depositedBonusAndFailedCycleHasExpired {
        ...
        vm.startPrank(earlyPledger2);
        goerliETHTerminal3_1_1.redeemTokensOf(
            earlyPledger2, failedProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, earlyPledger2, "", new bytes(0)
        );
    ...
    function testRedeemCalculatesCorrectRefundBonus() public depositedBonusAndFailedCycleHasExpired {
        ...
        vm.prank(earlyPledger1);
        goerliETHTerminal3_1_1.redeemTokensOf(
            earlyPledger1, failedProjectID, MIN_PLEDGE_AMOUNT, ethToken, 1, earlyPledger1, "", new bytes(0)
        );
        uint256 numEarlyPledgers = dominantJuice.numEarlyPledgers();
